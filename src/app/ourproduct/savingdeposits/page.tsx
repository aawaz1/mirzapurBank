...
const page = () => {
  ...
  return (
    <div>
       ...
       <div className='mt-16 w-full'> <BreadCrumb name='Our Products' title="Saving Deposits"/></div>
...
<div className="sm:text-center lg:text-left">
  <h2 className="my-6 text-2xl flex gap-4 tracking-tight font-extrabold text-gray-900 sm:text-3xl md:text-3xl">
    Saving Deposits <span className='border border-r-2 border-yellow-300'></span>
  </h2>
