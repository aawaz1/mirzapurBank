...
const Calculator = () => {
  ...
  return (
    <div className='bg-blue-950 h-[410px] p-3 flex flex-col justify-start gap-6 py-8 rounded-xl px-4 md:px-12 '>
      <div>
                      ...
                      </div>
      {
        projects.length > 0 ? (
            ...
            <button className=' bg-gradient-to-r from-blue-700 to-violet-600 p-1 px-2 flex justify-start items-center gap-4 text-white w-full rounded-full'> <span className='rounded-full text-white text-2xl'><PiSmileySad/></span>
